...
(function() {
	...
	FileList.prototype = {
		...
		initialize: function($el) {
			...
			$el.find('#controls').prepend(this.breadcrumb.$el);
		...
		setupUploadEvents: function() {
			...
			fileUploadStart.on('fileuploadadd', function(e, data) {
				...
				if (self.deleteFiles && FileList.deleteFiles.indexOf(data.files[0].name)!==-1) {
